...
<?php //Style for lmsmenu ?>
<style>
    .lmsmenu{background:#F5F5F5;padding:8px 0;
        box-shadow:0 3px 5px #8A8A8A;
        float:left;
        width:100%}.lmsmenuleft{float:left;padding-left:20px}.lmsmenuright{float:right;padding-right:20px}.lmsmenu img{vertical-align:inherit}
</style>