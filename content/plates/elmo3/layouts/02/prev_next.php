<div class="course__sidebar__overview">
    <a class="" href="<?= $lms_content_url ?>&about=course">
        <i class="icon dm-arrow-round-back" aria-hidden="true"></i>
        <span class="course__sidebar__overview__name">Course Overview</span>
        <span class="hoverText">course overview</span>
    </a>
</div>
